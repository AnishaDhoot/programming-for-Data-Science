...
#Step3:
#3.1.2. Create a scatter plot with color customizations ggplot(data = data, aes(x = a, y = b)) +
...
#Step3:
#3.2. Create a line plot & with customizations ggplot(data = data, aes(x = x, y = y)) +
